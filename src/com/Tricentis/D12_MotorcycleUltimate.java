...
public class D12_MotorcycleUltimate {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		new Select(driver.findElement(By.id("model"))).selectByValue("Scooter");
		...
		//Enter Product Data
		driver.findElement(By.id("startdate")).sendKeys("09/26/2025");
		...
		Thread.sleep(5000);
		String expPrice="3,366.00",expClaim="Submit",expDis="10",expCover="Unlimited",actPrice,actClaim,actDis,actCover;
